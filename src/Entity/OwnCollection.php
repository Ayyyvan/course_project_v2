...
/**
 * @ORM\Entity(repositoryClass=OwnCollectionRepository::class)
 */
class OwnCollection
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Item::class, mappedBy="ownCollection", orphanRemoval=true)
     */
    private $item;
